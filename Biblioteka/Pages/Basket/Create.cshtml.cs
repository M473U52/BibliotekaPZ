...
namespace Biblioteka.Pages.Basket
{
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(IBorrowingRepository borrowingRepository, IBookRepository bookRepository, IEmployeeRepository employeeRepository, IReader_BorrowingsRepository reader_BorrowingsRepository, UserManager<BibUser> userManager, IReaderRepository readerRepository)
        {
