...
namespace Biblioteka.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<BibUser> signInManager, ILogger<LoginModel> logger, UserManager<BibUser> userManager)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        Log.ForContext("SaveToFile", "AnyValue").Information($"Zalogowany użytkownik {Input.Email} - {role}");
                    }
